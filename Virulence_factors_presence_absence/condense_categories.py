#!/bin/python
#usage: python condense_categories.py -f [CSV file to simplify] -n [number that if entry is greater than or equal to, the script will condense to]
