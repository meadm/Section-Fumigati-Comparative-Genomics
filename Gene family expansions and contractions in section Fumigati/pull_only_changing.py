#!/bin/python
#this script will print all orthogroups in a dupliPHY-ML file that DO NOT have the exact same number of genes in every species in the file
...
for i in l:
    ...
    for j in i[1:]:
        ...
        if j != i[1]:
            check = 'Change'
    #if there are different numbers of genes in the species,
    if check == 'Change':
